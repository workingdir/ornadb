...
| `feat(postgres): dispatch one raw argument` | `crates/orna-postgres/src/kernel/security.rs` | Add argument dispatch. Old and barrier wrappers use empty arguments. DeepSeek owns inline order, audit, and savepoint tests. |
