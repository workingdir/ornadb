...
pub use frame::{
    ...
    ResourceCancelled, ResourceConnectionError, ResourceFrameDisposition, ResourceProtocolConnection,
...
mod tests {
    ...
    fn runtime_and_contract_offers_are_canonical_on_encode_and_decode() {
        ...
        let contract_a =
            InvocationRuntimeContract::new("alpha", "1", Vec::<String>::new()).unwrap();
        ...
        let features_left = RuntimeValue::InvokeRequest(minimal_invocation_request(
            ...
            vec![
                InvocationRuntimeOffer::new(
                    ...
                    Vec::<TypeDescriptor>::new(),
                    vec![
                        InvocationRuntimeContract::new("contract", "1", ["beta", "alpha"]).unwrap(),
                    ],
                    0,
                    false,
                    None,
        ...
        let features_right = RuntimeValue::InvokeRequest(minimal_invocation_request(
            ...
            vec![
                InvocationRuntimeOffer::new(
                    ...
                    Vec::<TypeDescriptor>::new(),
                    vec![
                        InvocationRuntimeContract::new("contract", "1", ["alpha", "beta"]).unwrap(),
                    ],
                    0,
                    false,
                    None,
        ...
        let duplicate_features = RuntimeValue::InvokeRequest(minimal_invocation_request(
            ...
            vec![
                InvocationRuntimeOffer::new(
                    ...
                    Vec::<TypeDescriptor>::new(),
                    vec![
                        InvocationRuntimeContract::new("contract", "1", ["alpha", "alpha"])
                            .unwrap(),
                    ],
                    0,
                    false,
            ...
            &RuntimeValue::InvokeRequest(minimal_invocation_request(
                ...
                vec![
                    InvocationRuntimeOffer::new(
                        ...
                        Vec::<TypeDescriptor>::new(),
                        vec![
                            InvocationRuntimeContract::new("zzzz", "1", Vec::<String>::new())
                                .unwrap(),
                            InvocationRuntimeContract::new("aaaa", "1", Vec::<String>::new())
                                .unwrap(),
                        ],
                        0,
                        false,
            ...
            &RuntimeValue::InvokeRequest(minimal_invocation_request(
                ...
                vec![
                    InvocationRuntimeOffer::new(
                        ...
                        Vec::<TypeDescriptor>::new(),
                        vec![
                            InvocationRuntimeContract::new("runt", "1", ["zzzz", "aaaa"]).unwrap(),
                        ],
                        0,
                        false,
                        None,
    ...
    fn invocation_event_carrier_round_trips_every_body_and_closed_scalar() {
        ...
        let mut events = vec![
            ...
            InvokeEvent::new(
                invocation,
                5,
                InvocationEventBody::cancelled(Some(String::from("operator stopped call")))
                    .unwrap(),
            )
            .unwrap(),
        ];
    ...
    fn invocation_carrier_raw_parser_rejects_version_selectors_names_and_nested_carriers() {
        ...
        let mut invalid_trust =
            encode_constructed_value(&active, &registry, &runtime_request).unwrap();
    ...
    fn invoke_value_carrier_rechecks_every_admitted_orv5_family_and_authority() {
        ...
        let nested_registry =
            registered_opaque_codecs(nested_active.catalogue_hash_context().standard().unwrap())
                .unwrap();
        let nested = RuntimeValue::InvokeValue(
            InvokeValue::new(nested_record_value(&nested_active)).unwrap(),
        );
        let nested_encoded =
            ...
            &RuntimeValue::InvokeRequest(minimal_invocation_request(
                ...
                vec![
                    InvocationRuntimeOffer::new(
                        ...
                        Vec::<TypeDescriptor>::new(),
                        vec![
                            InvocationRuntimeContract::new("contract", "release", ["feature"])
                                .unwrap(),
                        ],
                        0,
                        false,
