...
pub use resolver::{
    ...
    CheckedStandardTypeReference, CheckedStandardValueType, CheckedTypeId, CheckedTypeUseKind,
    ...
    ProvisionalTypeId, STD_INTEGER_TYPE_ID, STD_INVOKE_ECHO_FUNCTION_ID,
