...
pub(super) const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 48,
        name: "security admin audit boundary repair",
        sql: include_str!("../../../migrations/0048_security_admin_audit_boundary.sql"),
        data_step: None,
    },
    Migration {
        version: 49,
        name: "sealed invocation lifecycle",
    ...
    Migration {
        version: 51,
        name: "sealed invocation argument metadata",
    ...
    Migration {
        version: 53,
        name: "sealed invocation writer lease evidence",
        sql: include_str!("../../../migrations/0053_sealed_invocation_writer_lease.sql"),
        data_step: None,
    },
    Migration {
        version: 54,
        name: "sealed invocation catalogue witnesses",
