...
use local_identity::{
    append_client_capability_audit, catalogue_health_identity_error, catalogue_health_service_uid,
    insert_catalogue_health_identity, local_user_principal_id, local_user_security_snapshot,
    lock_catalogue_health_identity, require_catalogue_health_identity_preserved,
    require_catalogue_health_snapshot,
};
use persistence::*;
