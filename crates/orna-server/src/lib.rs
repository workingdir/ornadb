...
/// chain, is advanced through the complete accepted upgrade chain to V9/latest before
/// it returns; intentionally installed V1 and V9 snapshots are verified in place.
