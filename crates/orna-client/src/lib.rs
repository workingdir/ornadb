...
#[cfg(test)]
use resource_validation::stream_item_descriptor;
use resource_validation::{
    canonical_resource_argument_digest, canonical_resource_arguments,
    client_invocation_target_is_resolved, resolve_action_target, resolve_client_function,
    resolve_resource_operation_target, resolve_resource_target, resolve_unclassified_target,
    source_metadata_body_kind, source_metadata_return_metadata, source_metadata_type_id,
    source_reference_target_name, supported_stream_item_descriptor, validate_resource_arguments,
};
