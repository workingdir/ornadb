...
fn relation_name(type_id: TypeId) -> String {
    format!("t_{}", type_id_hex(type_id))
}

fn field_name(field_id: FieldId) -> String {
    format!("f_{}", field_id_hex(field_id))
}

fn type_id_hex(type_id: TypeId) -> String {
    raw_id_hex(type_id.to_bytes())
}

fn field_id_hex(field_id: FieldId) -> String {
...
mod tests {
    ...
    #[test]
    fn generated_names_use_exact_lowercase_raw_identity_bytes() {
