...
; Keyword-shaped declaration components are names. Match the grammar's
; keyword nodes directly so this query remains portable across Tree-sitter,
; Neovim, Helix, and Zed regex/query implementations.
(create_schema_statement
    name: (qualified_name [
        ...
        (kw_immutable) (kw_transient) (kw_persistable) (kw_sealed) (kw_kernel)
        (kw_contract) (kw_export) (kw_to) (kw_prelude) (kw_server) (kw_function)
        (kw_client) (kw_external) (kw_returns) (kw_table) (kw_rows) (kw_runtime)
        (kw_security) (kw_invoker) (kw_definer) (kw_transaction) (kw_atomic)
        (kw_read) (kw_only) (kw_manual) (kw_volatility) (kw_stable) (kw_volatile)
        (kw_requires) (kw_capability) (kw_alter) (kw_rename) (kw_field) (kw_add)
        (kw_drop) (kw_cascade) (kw_restrict) (kw_user) (kw_disabled) (kw_role)
        (kw_grant) (kw_revoke) (kw_on) (kw_from) (kw_execute) (kw_select)
        (kw_insert) (kw_update) (kw_delete) (kw_inspect) (kw_is) (kw_begin)
        (kw_end) (kw_if) (kw_then) (kw_elsif) (kw_else) (kw_while) (kw_loop)
        (kw_for) (kw_in) (kw_let) (kw_const) (kw_state) (kw_scope) (kw_local)
        (kw_session) (kw_default) (kw_not) (kw_null) (kw_unique) (kw_check)
        (kw_set) (kw_call) (kw_await) (kw_return) (kw_and) (kw_or) (kw_like)
        (kw_ilike) (kw_true) (kw_false) (kw_case) (kw_when) (kw_ref) (kw_list)
        (kw_map) (kw_stream) (kw_option) (kw_boolean) (kw_bool) (kw_integer)
        (kw_int) (kw_bigint) (kw_float) (kw_decimal) (kw_character) (kw_large)
        (kw_text) (kw_binary) (kw_bytes) (kw_uuid) (kw_date) (kw_time)
        (kw_timestamp) (kw_duration) (kw_void) (kw_distinct) (kw_order) (kw_by)
        (kw_asc) (kw_desc) (kw_values) (kw_returning) (kw_into) (kw_where)
    ] @namespace)
)
