...
kernel-test:
    ...
    ORNA_TEST_POSTGRES_ADMIN_URL='host=127.0.0.1 port=55432 user=ornadb_dev password=ornadb_dev_password' cargo test --package orna-kernel-postgres --features test-hooks --test bootstrap --test recovery --test apply --test server_execution -- --ignored --test-threads=1
